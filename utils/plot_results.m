...
if ~exist('measures', 'var') || isempty(measures),
    if strcmpi(datasetName, 'lfw224x224'), measures = {'error'};
    elseif strcmpi(datasetName, 'cacd2000_224x224'), measures = {'error'};
    elseif strcmpi(datasetName, 'cifar'), measures = {'error'};
    elseif strcmpi(datasetName, 'imagenet'), measures = {'error', 'error5'};
    elseif strcmpi(datasetName, 'mnist'), measures = {'error'};
