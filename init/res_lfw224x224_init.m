function net = res_lfw224x224_init_1(m, varargin)
switch m,
...
net.meta.trainOpts.learningRate = [0.00001*ones(1,80) 0.00001*ones(1,80) 0.0001*ones(1,40)] ;
net.meta.trainOpts.numEpochs = numel(net.meta.trainOpts.learningRate) ;

% First conv layer
block = dagnn.Conv('size',  [9 9 3 64], 'hasBias', true, ...
...
info = add_group(opts.networkType, net, n, info, 3, 64, 4, opts);
