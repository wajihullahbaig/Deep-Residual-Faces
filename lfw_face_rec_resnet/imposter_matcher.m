function imposter_matcher( lfw_path , resnet)
...
for i = 1:numel(directories)
    ...
    fileName1 = [lfw_path directory_name '/' directory_name '_000' num2str(1) '.jpg'];
    ...
    for j=i+1:numel(directories)
        directory_name = directories(j).name;
        if strcmp(directory_name,'.') == 1 || strcmp(directory_name,'..') == 1
            continue;
        end
        fileName2 = [lfw_path directory_name '/' directory_name '_000' num2str(1) '.jpg'];
