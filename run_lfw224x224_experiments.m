function run_lfw224x224_experiments(Ns, MTs, varargin)
% Usage example:  
...
for i=1:n_exp, 
  opts.checkpointFn = @() plot_results(expRoot, 'lfw224x224',[],[], 'plots', {MTs{i}});
  opts.expDir = fullfile(expRoot, ...
    sprintf('lfw224x224-%s-%d', MTs{i}, Ns(i))); 
  [net,info] = res_lfw224x224(Ns(i), 'modelType', MTs{i}, opts); 
  plot_results(expRoot, 'lfw224x224',[],[], 'plots', {MTs{i}});
end
